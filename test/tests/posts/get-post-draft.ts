...
//     const resp1 = await header.admin.put(
//       `/api/documents/${post.document._id}/elements/${post.document.elements[0]._id}`,
//       { html: updatedHTML } as IDraftElement<'client'>
//     );
//     const resp2 = await header.admin.post(`/api/documents/${post.document._id}/elements`, {
//       html: listHTML,
//       type: 'elm-list'
//     } as IDraftElement<'client'>);
//     const resp3 = await header.admin.post(`/api/documents/${post.document._id}/elements`, {
//       html: imgHTML,
//       type: 'elm-image',
//       image: file._id
...
//     let resp = await header.admin.post(`/api/documents/${post.document._id}/elements`, {
//       html: codeHtml,
//       type: 'elm-code'
//     } as IDraftElement<'client'>);
