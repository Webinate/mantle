...
//     const resp = await header.guest.put(`/api/documents/123456789012345678901234/elements/bad`, {
//       html: ''
...
//     const resp = await header.user1.put(`/api/documents/123456789012345678901234/elements/123456789012345678901234`, {
//       html: ''
//     } as IDraftElement<'client'>);
...
//   it('did not update an element on a document that doesnt exist', async function() {
//     const resp = await header.user1.put(`/api/documents/${document._id}/elements/123456789012345678901234`, {
//       html: ''
//     } as IDraftElement<'client'>);
//     assert.equal(resp.status, 404);
//   });
...
//     const resp = await header.guest.put(`/api/documents/${document._id}/elements/${document.elements[0]._id}`, {
//       html: ''
//     } as IDraftElement<'client'>);
...
//     const resp = await header.user2.put(
//       `/api/documents/${document._id}/elements/${document.elements[0]._id}`,
//       {} as IDraftElement<'client'>
//     );
...
//     const resp = await header.user1.put(`/api/documents/${document._id}/elements/${document.elements[0]._id}`, {
//       type: 'elm-header-1'
//     } as IDraftElement<'client'>);
...
//     const resp = await header.admin.put(`/api/documents/${document._id}/elements/${document.elements[0]._id}`, {
//       html: updatedHTML,
//       zone: 'zone-a'
//     } as IDraftElement<'client'>);
//     assert.equal(resp.status, 200);
