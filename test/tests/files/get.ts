...
describe('Getting uploaded user files', function() {
  ...
  it('regular user did not get files for a volume with bad id', async function() {
    ...
    assert.deepEqual(
      ...
      'Variable "$volumeId" got invalid value "test"; Expected type "ObjectId". Argument passed in must be a string of 12 bytes or a string of 24 hex characters or an integer'
    );
  });
