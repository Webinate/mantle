...
declare class Transport
{
	...
	sendMail(message: MailComposer, callback?: (err: Error, info: any) => any): any;
	send_mail(message: MailComposer, callback?: (err: Error, info: any) => any): any;
}
...
{
	service: string;
	auth: NodemailerSMTPTransportOptions | NodemailerTransportOptions;
}
...
interface Nodemailer
{
	...
	createTransport(options: ITransportOptions): Transport;
